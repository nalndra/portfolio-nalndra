export const site = {
  ...
  tech: ["React", "Next.js", "TypeScript", "Three.js", "Tailwind CSS"],
  projects: [
    { title: "Project Alpha", desc: "A responsive web app built with Next.js and Tailwind CSS.", link: "#" },
    { title: "3D Showcase", desc: "Interactive 3D demo using Three.js and GLTF models.", link: "#" },
  ],
};
